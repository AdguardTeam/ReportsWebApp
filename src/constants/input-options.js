...
export const STEALTH_OPTIONS = [
    ...
    { label: 'options.stealth.strip_url', type: 'Bool', shorthand: 'strip_url' },
    { label: 'options.stealth.block_third_party_auth', type: 'Bool', shorthand: 'block_third_party_auth' },
    ...
    { label: 'options.stealth.flash', type: 'Bool', shorthand: 'flash' },
    { label: 'options.stealth.java', type: 'Bool', shorthand: 'java' },
